...
<!DOCTYPE html>
<html>
<title>GOSSIP NODE MONITOR</title>
<meta charset="UTF-8">
...
<div class="w3-bar w3-top w3-black w3-large" style="z-index:4">
  ...
  <span class="w3-bar-item w3-right"><b>gossip_monitor</b> | <?php print $version;?></span>
</div>
  ...
  <?php
    ...
    if(!empty($getnetworkinfo)){
      if(!empty($mnaddress)){
        ...
        echo 'Masternode Address : <tr><a href=http://' . $gossip_explorer . '/address/' . $mnaddress . '>' . $mnaddress . '</a></tr>';
        echo "<td><a href=http://" . $gossip_explorer . "/address/" . $mnlist[$i]->{'addr'} .">" . $mnlist[$i]->{'addr'} . "</a></td>";
      }
      elseif(empty($mnaddress)){
        echo '<li class="w3-padding-16 w3-orange">';
        echo '<span class="w3-xlarge">';
        echo 'GOSSIP Daemon is running but is not a Masternode';
      }
    }
    else{
      echo '<li class="w3-padding-16 w3-orange">';
